...
export const TYPE_REFERENCES: TypeReference[] = [
  {
    ...
    description:
      "CLAUDE.mdが整備され、Auto Mode・/effortを活用し、基本的なMCPが接続されている状態が理想。",
    items: buildItems(
      ["CLAUDE.md品質", "MCP構成"],
      ["フック構成", "セッション間引き継ぎ", "モデル戦略"],
    ),
  },
  {
    typeId: "specDriven",
    ...
    description:
      "仕様書先行、AGENTS.md標準化、タスク分割→1タスク1コミット、テストファースト。設計に基づいた堅実な開発が理想。",
    items: buildItems(
      [
      ...
      [
        ...
        "デバッグ能力", "セキュリティ", "モデル戦略", "サブエージェント活用",
      ],
    ),
  },
  {
    ...
    description:
      "5つの柱が完全実装。HTTP Hooks・21フックイベント・Plugin Marketplace・conditional ifを含む全27項目が必須。",
  ...
  },
  {
    ...
    description:
      "Agent Teams/Swarm Modeで並列開発。isolation: worktree、/loop、Remote Control、--channelsによる大規模オーケストレーションが理想。",
    items: buildItems(
      [
        "CLAUDE.md品質", "MCP構成", "サブエージェント活用", "並列開発",
        "テスト・検証戦略", "セキュリティ", "デバッグ能力", "通信・遠隔",
      ],
      [
        "スキル数と多様性", "スラッシュコマンド", "コンテキスト管理",
        "フック構成", "品質自動強制", "自動化レベル", "安全設計", "モデル戦略",
      ],
    ),
  },
  {
    ...
    description:
      "Worker-Criticペア、加重スコアリング、Adversarial QA、PostCompactフック、Context Engineeringを活用した再現性重視の研究環境が理想。",
    items: buildItems(
      [
  ...
  },
  {
    ...
    description:
      "KPI 4柱×3フレームワーク、クラウドスケジュールタスク、Opus 4.6 1M戦略、安全設計による成果最適化が理想。",
    items: buildItems(
      [
        "CLAUDE.md品質", "MCP構成", "サブエージェント活用", "並列開発",
